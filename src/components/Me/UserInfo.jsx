                                ...
                                <div id="socials" className="mt-6 w-96 flex flex-col  rounded-[20px] p-5 bg-gray-100 divide-solid">
                                    ...
                                    <div className="mt-6 flex items-center">
                                        ...
                                        <div>
                                            ...
                                            <Link to="#">
                                                <Typography variant="h6" className="decoration-2 underline text-[10px]" color="blue">{user.userEmail.socials.facebook}</Typography>
                                            </Link>
                                        </div>
                                    </div>
                                    ...
                                    <div className="mt-6 flex items-center">
                                        ...
                                        <div>
                                            ...
                                            <Link to="#">
                                                <Typography variant="h6" className="decoration-2 underline text-[10px]" color="blue">{user.userEmail.socials.ig}</Typography>
                                            </Link>
                                        </div>
                                    </div>
                                    ...
                                    <div className="mt-6 flex items-center">
                                        ...
                                        <div>
                                            ...
                                            <Link to="#">
                                                <Typography variant="h6" className="decoration-2 underline text-[10px]" color="blue">{user.userEmail.socials.x}</Typography>
                                            </Link>
                                        </div>
                                    </div>
                                    ...
                                    <div className="w-screen flex flex-col justify-center rounded-[20px] p-4 bg-gray-100">
                                        ...
                                        <form className="mt-6" onSubmit={handleSubmit}>
                                            <div className="grid gap-6 mb-6 md:grid-cols-2">
                                                ...
                                                <div>
                                                    <label htmlFor="birth" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Birthday</label>
